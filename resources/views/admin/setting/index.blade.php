                ...
                <form action="{{ route('admin.setting.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input type="text" name="url_tiktok" value="{{$settings['url_tiktok']}}" class="form-control" >
                            @error('url_tiktok')
                                <span class="invalid-feedback" role="alert" <strong>{{ $message }}</strong>
                                </span>
                            @enderror
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input type="text" name="url_facebook" value="{{$settings['url_facebook']}}" class="form-control" >
                            @error('url_facebook')
                                <span class="invalid-feedback" role="alert" <strong>{{ $message }}</strong>
                                </span>
                            @enderror
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input type="text" name="url_instagram" value="{{$settings['url_instagram']}}" class="form-control" >
                            @error('url_instagram')
                                <span class="invalid-feedback" role="alert" <strong>{{ $message }}</strong>
                                </span>
                            @enderror
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input type="text" name="url_youtube" value="{{$settings['url_youtube']}}" class="form-control" >
                            @error('url_youtube')
                                <span class="invalid-feedback" role="alert" <strong>{{ $message }}</strong>
                                </span>
                            @enderror
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input type="text" name="url_twitter" value="{{$settings['url_twitter']}}" class="form-control" >
                            @error('url_twitter')
                                <span class="invalid-feedback" role="alert" <strong>{{ $message }}</strong>
                                </span>
                            @enderror
